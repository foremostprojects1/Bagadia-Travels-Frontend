          ...
          <div className="row g-0">
                  ...
                  <div className="swiper-wrapper">
                    {/* <SwiperSlide className="swiper-slide"> */}
                      <div className="slider-content">
                        ...
                        <p>
                        "Your safety is our top priority. Our meticulous safety systems are designed to provide you with unparalleled peace of mind, ensuring a secure and worry-free travel experience. From stringent hygiene protocols to expertly trained staff, we go above and beyond to safeguard your well-being every step of the way."
                        </p>
                        <ul>
                          <li>
                            <svg
                    ...
                    {/* <SwiperSlide className="swiper-slide">
                      <div className="slider-content">
                        ...
                        <p>
                        "Discover excellence in our premises services, where attention to detail and top-notch amenities meet to enhance your overall experience. From immaculate accommodations to convenient facilities, we strive to exceed your expectations and make your stay truly memorable."
                        </p>
                        <ul>
                          <li>
                            <svg
            ...
            <div className="col-lg-6">
              <div className="franctional-slider-right-img">
                <img src="/assets/img/home1/facility-img.jpg" alt="" />
                {/* <div className="logo">
                  <img
