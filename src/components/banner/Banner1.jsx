            ...
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(assets/img/home1/home1-banner-img1.jpg)",
                  }}
                >
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(assets/img/home1/home1-banner-img2.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(assets/img/home1/home1-banner-img3.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(assets/img/home1/home1-banner-img4.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
