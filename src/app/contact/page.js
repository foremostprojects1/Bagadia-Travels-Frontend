...
const page = () => {
  ...
  return (
    <>
      <div className="contact-page pt-80 mb-120">
              ...
              <div className="contact-form-area">
                ...
                <form>
                  <div className="row">
                    ...
                    <div className="col-lg-6 mb-20 ">
                      <div className="form-inner">
                        <label style={{ display: "block" }}>Travel Date*</label>
                        <DatePicker
                          selected={startDate}
                    ...
                    <div className="col-lg-6 mb-20">
                      <div className="form-inner">
                        <label>Number of Persons* (Age 12+)</label>
                        <input
                          type="number"
                    ...
                    <div className="col-lg-6 mb-20">
                      <div className="form-inner">
                        <label>Number of Kids* (Age 2-12)</label>
                        <input
                          type="number"
                    ...
                    <div className="col-lg-6 mb-20">
                      <div className="form-inner">
                        <label>Number of Infants* (Age Upto 2)</label>
                        <input
                          type="number"
                          placeholder="Number of Infants"
                          value={numberOfInfant}
                          onChange={(e) => setNumberOfInfant(e.target.value)}
                        />
                      </div>
                    </div>
                    <div className="col-lg-6 mb-20">
